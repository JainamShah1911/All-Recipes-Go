...
function bp_the_notification_description() {
	...
	function bp_get_the_notification_description() {
		...
		// Allow non BuddyPress components to hook in.
			...
			$description = '<a href='.get_permalink($notification->item_id).'>'.bp_core_get_username($notification->secondary_item_id).' posted a new recipe: '.get_the_title($notification->item_id).'</a>';
		}
