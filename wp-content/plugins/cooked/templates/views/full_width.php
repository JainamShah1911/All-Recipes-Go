<?php global $cooked_query; $is_page = is_page(); $no_results = false; ?>
						...
						<div class="cp-box">
							<div class="cp-box-img">
								<?php if(!empty($entry_image)) {
									echo '<a href="'.$entry_link.'">'.wp_get_attachment_image($entry_image, 'cp_500_500').'</a>';
								} else {
									echo '<a href="'.$entry_link.'"><img src="'.CP_PLUGIN_URL.'/css/images/default_500x500.png"></a>';
								}
								?>
							</div><!-- /.cp-box-img -->
