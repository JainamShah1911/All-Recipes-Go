...
//////////////////////////////////////////////////////////////
// Get the modal
var modal99 = document.getElementById('digital_timer99');
var modal1 = document.getElementById('digital_timer1');
var modal2 = document.getElementById('digital_timer2');
var modal3 = document.getElementById('digital_timer3');
var modal4 = document.getElementById('digital_timer4');
var modal5 = document.getElementById('digital_timer5');

// Get the button that opens the modal
var btn99 = document.getElementById("timer_button99");
var btn1 = document.getElementById("timer_button1");
var btn2 = document.getElementById("timer_button2");
var btn3 = document.getElementById("timer_button3");
var btn4 = document.getElementById("timer_button4");
var btn5 = document.getElementById("timer_button5");
...
/////////////////////////////////////////////////////
		...
		// Recipe madeit button
		$('.madeit-btn').each(function() {
			var $button      = $(this),
				$icon        = $button.find('> i'),
				madeRecipes = $.cookie('cpmadeitRecipes'),
				recipeID     = $button.attr('data-recipe-id');
				cookied      = $button.attr('data-cookied');
				userMade	 = $button.attr('data-userMadeit');

			if ( cookied == 1 && typeof madeRecipes !== 'undefined' && madeRecipes.split(',').indexOf(recipeID) > -1 || userMade == 1 ) {
				$icon.removeClass('fa-thumbs-o-up').addClass('fa-thumbs-up');
			}

		});

		$cooked_pp.find('.madeit-btn').on('click', function() {
			var $button      = $(this),
				$icon        = $button.find('> i'),
				$count       = $button.find('.madeit-count'),
				count        = parseInt($count.text()),
				madeRecipes = $.cookie('cpmadeitRecipes'),
				recipeID     = $button.attr('data-recipe-id'),
				cookied		 = $button.attr('data-cookied'),
				madeURL      = $button.attr('href'),
				madeAction;
			...
			if ( $icon.hasClass('fa-thumbs-o-up') ) {
				...
				if (cookied == 1){
					if ( typeof madeRecipes === 'undefined' ) {
						madeRecipes = recipeID;
					} else {
						madeRecipes = madeRecipes + ',' + recipeID;
					}
	
					$.cookie('cpmadeitRecipes', madeRecipes, { expires: 365 } );
				}
				...
				if (cookied == 1){
					if ( typeof madeRecipes === 'undefied' ) {
						return false;
					}
				}

				if (cookied == 1){
					var likedSplit = madeRecipes.split(','),
						recipeIdx  = likedSplit.indexOf(recipeID);
	
					if ( recipeIdx > -1 ) {
						likedSplit.splice( recipeIdx, 1 );
						madeRecipes = likedSplit.join(',');
	
						$.cookie('cpmadeitRecipes', madeRecipes, { expires: 365 } );
	
						madeAction = 'dismadeit';
					}
				} else {
					madeAction = 'dismadeit';
				}
