<div id="cooked-admin-panel-container">
	...
	<div class="section-row">
		...
		$detailed_ingredients = get_post_meta($post_id, '_cp_recipe_detailed_ingredients', true);
		...
		<ul class="cooked-admin-tabs-alt cookedClearFix">
			<li<?php echo $number_of_ingredients >= 1 || !$ingredients ? ' class="active"' : ''; ?>><a href="#ingDetailed"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;<?php _e('Detailed Entry','cooked'); ?></a></li>
			<li<?php echo $number_of_ingredients <= 0 && $ingredients ? ' class="active"' : ''; ?>><a href="#ingClassic"><?php _e('Simple Entry','cooked'); ?></a></li>
		</ul>
										...
										<td class="field-wrapper">
											<table>
												<tr>
													...
													<td class="field-label"><label><?php _e('Ingredient', 'cooked'); ?></label></td>
													<td class="actions-holder">
														<a href="#" class="action-button clone-button fa fa-copy" data-action="duplicate" title="<?php _e('Clone','cooked'); ?>"></a>
														<a href="#" class="action-button remove-button fa fa-times-circle" data-action="remove" title="<?php _e('Remove','cooked'); ?>"></a>
													</td>
												</tr>
												<tr class="inner-fields-wrapper">
													<td class="field-one">
														<input type="hidden" name="<?php echo $partial_name; ?>[type]" value="ingredient" data-partial-name="[type]" />
														<input type="text" name="<?php echo $partial_name; ?>[amount]" value="<?php echo !empty($entry['amount']) ? $entry['amount'] : ''; ?>" data-partial-name="[amount]" />
													</td>
													<td class="field-two">
														<div class="select-style-two">
													...
													<td class="field-three" colspan="2">
														<input type="text" name="<?php echo $partial_name; ?>[name]" value="<?php echo !empty($entry['name']) ? esc_attr($entry['name']) : ''; ?>" class="autocomplete-field" data-partial-name="[name]" />
													</td>
												</tr>
											</table>
										</td>
	...
	<div class="section-row">
		...
		$detailed_directions = get_post_meta($post_id, '_cp_recipe_detailed_directions', true);
		...
		<ul class="cooked-admin-tabs-alt cookedClearFix">
			<li<?php echo $number_of_directions >= 1 || !$directions ? ' class="active"' : ''; ?>><a href="#drDetailed"><i class="fa fa-list-ol"></i>&nbsp;&nbsp;<?php _e('Detailed Entry','cooked'); ?></a></li>
			<li<?php echo $number_of_directions <= 0 && $directions ? ' class="active"' : ''; ?>><a href="#drClassic"><?php _e('Simple Entry','cooked'); ?></a></li>
		</ul>
							...
							<table>
								<tr>
									<td class="attachment-field cp-media-uploader-wrapper">
										<span class="attachment-droparea cp-media-action" data-window-button-label="<?php _e('Select direction image','cooked'); ?>" data-window-label="<?php _e('Direction image','cooked'); ?>"><i class="fa fa-file-image-o"></i></span>
									...
									<tr class="sortable-row field-standard field-direction field-row">
										...
										<td class="field-wrapper field-wrapper-alt">
											<table>
												<tr>
													<td class="attachment-field cp-media-uploader-wrapper">
														<span class="attachment-droparea cp-media-action" data-window-button-label="<?php _e('Select direction image','cooked'); ?>" data-window-label="<?php _e('Direction image','cooked'); ?>"<?php if(!empty($entry['image_id'])) : ?> style="display: none;"<?php endif; ?>><i class="fa fa-file-image-o"></i></span>
	...
	<div class="section-row">
		...
		<div class="section-body">
			...
			<?php wp_editor( $short_decription, '_cp_recipe_short_description', array('textarea_name' => '_cp_recipe_short_description','media_buttons' => false,'editor_height' => 250,'teeny' => true,'editor_class' => 'cp_recipe_editor') ); ?>
		</div><!-- /.section-body -->
	</div><!-- /.section-row -->
	...
	<div class="section-row">
		...
		<div class="section-body">
			<?php $recipe_excerpt = get_post_meta($post_id, '_cp_recipe_excerpt', true); ?>
			<textarea class="field small" name="_cp_recipe_excerpt" cols="0" rows="0"><?php echo $recipe_excerpt; ?></textarea>
			<p class="hint-p">
	...
	<div class="section-row">
		...
		<div class="section-body">
			...
			<?php wp_editor( $additional_notes, '_cp_recipe_additional_notes', array('textarea_name' => '_cp_recipe_additional_notes','media_buttons' => false,'editor_height' => 250,'teeny' => true,'editor_class' => 'cp_recipe_editor') ); ?>
			<p class="hint-p">
