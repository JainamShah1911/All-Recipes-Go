	...
	if ( is_user_logged_in() ) {
		...
		if (!empty($required_user_roles)):
			...
			if (in_array($current_user_role,$required_user_roles)){
				...
				?><div id="cooked-recipe-editor"><form id="cooked-submit-recipe-form" action="<?php echo trailingslashit(urldecode(get_permalink($post_id))).'?edit'; ?>" method="post" enctype="multipart/form-data">
					...
					<input id="submit" type="submit" class="sbmt-button" value="<?php _e( 'Update Recipe', 'cooked' ); ?>" />					
