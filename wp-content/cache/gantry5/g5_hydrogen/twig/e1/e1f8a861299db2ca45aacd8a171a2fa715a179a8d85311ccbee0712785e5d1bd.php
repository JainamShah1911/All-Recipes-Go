...
class __TwigTemplate_c4f374e6f7384de00f23e52db51663faa4b06f6e5cfa1eeabc4012d29d83f06e extends Twig_Template
{
...
";
        ...
        if ((call_user_func_array($this->env->getFunction('function')->getCallable(), array("get_option", "thread_comments")) == "1")) {
            ...
            // line 5
            echo "        ";
            echo $this->getAttribute((isset($context["wordpress"]) ? $context["wordpress"] : null), "call", array(0 => "wp_enqueue_script", 1 => "comment-reply"), "method");
            echo "
    ";
...
";
    ...
    {
        return new Twig_Source("", "partials/comments.html.twig", "C:\\wamp64\\www\\wordpress\\wp-content\\themes\\g5_hydrogen\\views\\partials\\comments.html.twig");
    }
}
